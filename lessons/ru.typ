# !/usr/bin/gtypist
#
#	Russian basic GNU Typist course script
#	for standard Russian cyrillic keyboard.
#	
...
#
#	NOTE:  original of this file is in KOI8-R.
...
T:
 ...
 :известна суть этого метода хотя бы в общих чертах, а также какие преимущества
 :он может обеспечить.  Если нет --- не волнуйтесь, в следующем меню есть пункт
 :"помощь", в котором подробно изложена суть метода и основные рекомендации,
 :причём так, что они будут понятны кому угодно.  Там же приведена прочая
 :информация, которая может оказаться полезной на случай, если вы испытываете
 :сложности с этим и другими курсами слепой печати, а также сведения о проекте
 :GNU Typist и об этих уроках.
 :
 :----------------------------------------------------------------------------
 :
 :    Авторское право на этот курс принадлежит Дмитрию Руцкому,
 :Copyright (C)  2003  Dmitry Rutsky  <rutsky@school.ioffe.rssi.ru>.
 ...
 :в лицензии.  В частности, запрещается использовать этот курс или любую его
 :часть в коммерческих программах (но вы можете заключить отдельное лицензионное
 :соглашение с владельцем авторского права).
*:START
B:Серии упражнений
M: "Выберите нужную вам серию занятий:"
...
#
#	These letters are usually first children learn from Russian ABC :-)
#
...
T:
 ...
 :выполнять?  Если нет, то вам лучше узнать это в разделе "помощь и справка".
 :Упражнение может показаться вам лёгким (и это хорошо), но впоследствии вам
 :может оказаться значительно труднее, поэтому приучайтесь делать всё правильно
 :и аккуратно с самого начала.
 :
 :    Клавиши `А' и `О' в основной позиции будут нажимиться указательными
 :пальцами левой и правой руки соответственно.  Они расположены в самом удобном
 ...
 :очень скоро вам станет легче.  Не смотрите на клавиатуру!
 :
 ...
 :Ритмично выполняйте упражнения.  Используйте фантазию, напевайте эти сочетания
 :символов --- и вам будет легче и интереснее!
 :
 :    Не переходите к следующему упражнению, пока не вполне освоились с
 :предыдущими.
...
I:И ещё немного.
 :ааа а а аааа а
B:`О' и `А' поочерёдно
I:Теперь вам придётся немного напрячь мозги и почувствовать, где какие находятся
 :указательные пальцы ваших рук.
...
T:
 ...
 :Не допускайте этого!  Поставьте кисть руки в основную позицию и попробуйте
 :плавно приподнимать средний палец над клавиатурой и так же плавно опускать
 :его, оставляя всю остальную кисть такой же расслабленной.  Не удивляйтесь,
 :если сначала у вас не будет это получаться.  Но нужно обязательно приобрести
...
D:ни пера ни пера нить горела нить горела эти рати эти рати жрать не в мере
 ...
 :нервы истинны нервы истинны тмин и аминь тмин и аминь
Q:Перейти к проверочной работе? [Д/Н]
N:__INDEX_FS
*:IF_TEST
...
T:
 ...
 :информации, возникла проблема эффективного ввода текстов в различные
 :устройства.  Первоначально это были пишущие машинки и устройства для
 :типографского набора, но затем появились компьютеры, и в настоящее время с
 ...
 :и эффективное её использование должно входить в набор умений, составляющих
 :основную грамотность в использовании компьютера.
 :
 ...
 :Эффективно ли вы используете клавиатуру?  Если вы используете "интуитивный"
 :метод, то сильно ли вы устаёте от его использования?  Не болит ли у вас
 :голова от постоянных взглядов на клавиши?  Не устают ли ваши руки от
 :постоянного блуждания по ним?
B:Свободное владение клавиатурой
T:
 :    Основная задача слепого десятипальцевого метода --- свободно работать
 :с клавиатурой.  Это означает, что вы совершенно автоматически и без
 :каких-либо затруднений набираете любой текст, так же, как, например,
 ...
 :предполагает, что вам не нужно смотреть на клавиатуру вообще.  Вы в это вмемя
...
T:
 ...
 :можно посмотреть для того, чтобы понять и попробовать основные движения, но
 :если вы будете всё время поглядывать на неё, это просто сведёт на нет усилия
 :по достижению второй цели --- автоматизма.
...
T:
 ...
 :лёгкость и точная координация движений.  Сама по себе слепая десятипальцевая
 ...
 :средние пальцы обычно достаточно хорошо развиты, этого нельзя сказать об
 :безымянном и мизинце, и для всех развитие этих пальцев обычно представляет
 ...
 :Облегчить эту задачу мог бы опытный преподаватель, но его, к сожалению,
 :трудно найти.
...
T:
 ...
 :уровне ваших локтей или чуть ниже, и так, чтобы ваш взгляд на неё упирался в
 :клавиши "G" и "H" ("П" и "Р").  Сидеть лучше на чём-нибудь жёстком, и движения
 :ваших рук ничто не должно стеснять (кресло будет мешать вам).
 :
 ...
 :поднять расслабленную руку над клавиатурой (чтобы расслабленные пальцы лежали
...
T:
 ...
 :больше опыта, вы будете объединять отдельные движения.  Рука должна быть
 :расслаблена.  Лучше держать её на весу, но если вам сложно, вы можете
 :использовать специальную подставку, или держать запястья на столе.  Но многие
 :подставки стесняют движения, и для максимальной скорости нужно держать руки на
 :весу.
 :
 :    Ваши пальцы во время выполнения движений должны работать настолько мягко и
 :нежно, насколько возможно, и затрачивать только усилия, необходимые на
 :перемещение пальцев и нажатие на клавиши.  Кисть не должна твёрдо стоять на
...
T:
 ...
 :пробел вслепую.  Эти клавиши заслуживают особого внимания.
 :
 ...
 :руководства рекомендуют нажимать его всё время одним пальцем:  при этом легче
 :всего добиться автоматизма.  На пишущих машинках рекомендовалось нажимать его
 :пальцем той руки, которая не печатала последний введённый перед пробелами
 :символ:  нагрузка при этом примерно равномерно распределяется по пальцам.
 :Ещё один подход состоит в том, чтобы нажимать пробелы последовательно обеими
 ...
 :больше движений и рука больше напрягалась для удара по клавишам, там нужно
 :было равномерно распределять нагрузку по всем рукам.  Третий метод единственно
 :эффективен, когда нужно набрать несколько пробелов подряд, но точно следовать
 :ему при печати текста сложно.  С практикой вы приобретёте эффективную для себя
...
T:
 ...
 :делать это так с самого начала, можете попробовать не поворачивать кисть,
 :а перемещать её вправо, оставляя указательный палец легко держаться за
 :клавишу, но остальным позволяя сдвинуться со своих мест и вернуть их после
 ...
 :можете отказаться от него, пересматривая свои навыки печати на ощупь.
 :
...
T:
 ...
 :достижения "в относительном плане", вы можете сейчас выполнить один или
 :несколько тестов из раздела "тесты" старым методом, и записать где-нибудь
 :ваши результаты, чтобы впоследствии сравнить их с теми, которые у вас будут
 :после курса и теми, что будут у вас после длительного повседневного
 :использования их в вашей деловой практике.  Тогда вы сможете ещё ощутимее
 :хвастаться и гордиться своими достижениями, особенно если они были достигнуты 
 :в короткий срок!  Нам, разработчикам программы и автору этого курса, было бы
 :интересно узнать, кто какие курсы использовал и с какими успехами.
G:__HELP
...
T:
 ...
 :символов и приёмов, а также проверочную работу, которая завершает каждый
...
T:
 ...
 :данные в этом разделе и других разделах курса.  
 :
 :    Пара слов о различии "теории" и "практики":  "теория" сложнее.  Дело в
...
T:
 ...
 :но и взрослый человек при наличии воли может многого добиться.
 :
...
T:
 ...
 :который описан в разделе "основы слепой печати").
 :
 ...
 :среднего ряда.  Это облегчает её усвоение и использование, освоив слепой
 :десятипальцевый метод, вы оцените это.
 :
...
T:
 ...
 :печати на разных языках и для разных применений, с которой вы сейчас работаете.
 ...
 :сообщите нам!  Как иначе мы сможем узнать ваши нужды?
 :
 :    Вы даже можете составлять собственные сценарии уроков или изменять
 :существующие.  Если ваши изменения могут быть полезны кому-то ещё, вы можете
...
T:
 ...
 :права лицензии GPL.  Практически это означает, что работы, основанные на этой
 ...
 :авторском праве.  Смотрите в текст лицензии для деталей.  Важным следствием
 :открытых исходников является то, что вы можете почти как угодно использовать
 :программу в личных целях, лично для вас она вся ваша!  Если вам непонятно, в
 :чём здесь преимущества, не задумывайтесь и продолжайте спокойно жить дальше.
 :
...
T:
 ...
 :получить полное представление о том, что нужно для следующей версии программы
 :GNU Typist --- автор является одним из её разработчиков.  Конечно,
 :существовало и существует множество курсов, некоторые весьма интересны, а
 :также есть современные печатные пособия, но многим из них не хватает
 :достаточной целостности.  Автора побудили ещё и собственные воспоминания.
 :Его мать закончила курсы машинописи незадолго до его рождения (что не могло
 :не сказаться на его психическом здоровье, как некоторые полагают), и уже в
 :детском возрасте он осваивал могучий инструмент --- механическую пишущую
 :машинку.  Хотя никто особенно не заботился о его занятиях (отец умер, а мать
 :должна была искать заработка для трёх детей в это трудное для страны время),
 :два учебника по машинописи всё же помогли довольно сносно освоить
 :десятипальцевый метод.  Эти навыки впоследствии очень пригодились в школе.
 :В старших классах ему тоже повезло, в программе оказались занятия
 :по освоению слепой печати латинским алфавитом.  Там же было высказано
 :предложение сделать аналогичный курс для русского алфавита, что он и выполнил
 :сейчас, по прошествии нескольких лет.
T:
 :    Создавать курс было и утомительно и интересно.  Все упражнения в курсе
 :оригинальны, автор изредка обращался за помощью при подборе слов к учебникам
 :машинописи и орфографическим словарям.  При создании курса автор основывался
 :прежде всего на своём собственном опыте, на представлениях, этим путём
 :полученных, и размышлениях над ними.  Достаточно вразумительной литературы
 :по этой теме найти не удалось, а существующие курсы обычно ограничивались
 :поверхностными практическими рекомендациями;  автору этот путь казался
 :неприемлемым --- он помнил, сколько времени и сил он потратил зря на своих
 :собственных ошибках.
 :
 :    Курс по изложению материала получился оригинальным --- обычно не
 ...
 :оправдана.  Впрочем, пока просто не оказалось никого рядом для того чтобы с
 :ним поспорить.
 :
 :    У автора пока не было много времени, чтобы "отшлифовать" этот курс,
 :поработать самому над всеми упражнениями, найти и устранить оставшиеся
 :опечатки и неточности и восполнить недостающие детали (других дел хватает ---
 :автор учится на математическом факультете университета) поэтому он был бы рад
 :любой помощи в этом занятии.  Спасибо за внимание!
G:__HELP
